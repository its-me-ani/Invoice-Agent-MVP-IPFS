...
$(document).ready(function () {
	...
	player.initialize();
	// Disabled: Real-time collaboration polling (endpoints not implemented)
	// Uncomment the line below to enable collaboration features
	// updater.poll();
});
...
SocialCalc.Callbacks.broadcast = function (type, data) {
	// Disabled: Real-time collaboration broadcast (endpoint not implemented)
	// To enable, uncomment the code below and implement /broadcast endpoint
	return;
