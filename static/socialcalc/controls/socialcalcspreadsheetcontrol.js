...
SocialCalc.SpreadsheetControl = function () {
   ...
   this.tabs.push({
      name: "settings", text: "Format", html:
         ...
         '      <span style="color:#888;font-size:8px;">Number</span>' +
         '     </div>' +
         '     <div style="display:flex;flex-direction:column;align-items:center;">' +
         ...
         '      <span style="color:#888;font-size:8px;">Horiz</span>' +
         '     </div>' +
         '     <div style="display:flex;flex-direction:column;align-items:center;">' +
         '      <span id="%id.calignvert"></span>' +
         '      <span style="color:#888;font-size:8px;">Vert</span>' +
         '     </div>' +
         '    </div>' +
         '   </div>' +
         '   <span style="color:#555;align-self:center;">|</span>' +
   ...
   this.tabs.push({
      name: "sheetsettings", text: "Sheet", html:
         '<div id="%id.sheetsettingstools" style="display:none;padding:4px 8px;">' +
         ' <div id="%id.sheetscolorchooser" style="display:none;position:absolute;z-index:20;"></div>' +
         ' <div style="display:flex;align-items:flex-start;gap:8px;flex-wrap:wrap;font-size:10px;">' +
         '  <div style="display:flex;flex-direction:column;gap:2px;">' +
         '   <span style="color:#AAA;font-size:9px;">FORMAT</span>' +
         '   <div style="display:flex;gap:4px;">' +
         '    <div style="display:flex;flex-direction:column;align-items:center;">' +
         ...
         '     <span style="color:#888;font-size:8px;">Num</span>' +
         '    </div>' +
         '    <div style="display:flex;flex-direction:column;align-items:center;">' +
         ...
         '   <div style="display:flex;gap:4px;">' +
         '    <div style="display:flex;flex-direction:column;align-items:center;">' +
         '     <span id="%id.textcolor"></span>' +
         '     <span style="color:#888;font-size:8px;">Text</span>' +
         '    </div>' +
         '    <div style="display:flex;flex-direction:column;align-items:center;">' +
         '     <span id="%id.bgcolor"></span>' +
         '     <span style="color:#888;font-size:8px;">Bg</span>' +
         '    </div>' +
         '   </div>' +
         '  </div>' +
         ...
         '  <span style="color:#555;align-self:center;">|</span>' +
         '  <div style="display:flex;flex-direction:column;gap:2px;">' +
         '   <span style="color:#AAA;font-size:9px;">SHEET</span>' +
         '   <div style="display:flex;gap:4px;">' +
         '    <div style="display:flex;flex-direction:column;align-items:center;">' +
         '     <span id="%id.colwidth"></span>' +
         '     <span style="color:#888;font-size:8px;">ColW</span>' +
         '    </div>' +
         '    <div style="display:flex;flex-direction:column;align-items:center;">' +
         '     <span id="%id.recalc"></span>' +
         '     <span style="color:#888;font-size:8px;">Recalc</span>' +
         '    </div>' +
         '   </div>' +
         '  </div>' +
         ' </div>' +
      ...
      onclick: function (s, t) {
         SocialCalc.SettingsControls.idPrefix = s.idPrefix;
         SocialCalc.SettingsControls.applyInstantly = true; // Enable instant apply for sheet settings
         SocialCalc.SettingsControls.isSheetPanel = true; // Flag for sheet panel
         SocialCalc.SettingControlReset();
   ...
   this.views["settings"] = {
      ...
      oncreate: function (s, viewobj) {
         ...
         viewobj.values.cellspanel = {
            ...
            calignhoriz: {
               setting: "alignhoriz", type: "PopupList", id: s.idPrefix + "calignhoriz",
               initialdata: scc.SCFormatTextAlignhoriz
            },
            calignvert: {
               setting: "alignvert", type: "PopupList", id: s.idPrefix + "calignvert",
               initialdata: scc.SCFormatAlignVertical
            },
   ...
   this.tabs.push({
      name: "comment", text: "Comment", html:
   ...
   this.tabs.push({
      name: "clipboard", text: "Clipboard", html:
   ...
   this.views["clipboard"] = {
      name: "clipboard", divStyle: "overflow:auto;", html:
...
SocialCalc.SettingsControls.PopupListInitialize = function (panelobj, ctrlname) {
   ...
   SocialCalc.Popup.Create("List", panelobj[ctrlname].id, { inputWidth: '45px' });
