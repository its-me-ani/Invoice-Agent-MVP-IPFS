...
SocialCalc.CreateTableEditor = function (editor, width, height) {
   ...
   td.innerHTML = "<div style='cursor:pointer;font-size:1px;'><img src='" + editor.imageprefix + "1x1.svg' border='0' width='18' height='18'></div>";
   tr.appendChild(td);
   editor.logo = td;
...
SocialCalc.EditorSaveEdit = function (editor, text) {
   ...
   if (SocialCalc.Callbacks.editAutoSave) {
      SocialCalc.Callbacks.editAutoSave();
   }
...
SocialCalc.CreateTableControl = function (control) {
   ...
   params = {
      repeatwait: scc.TClessbuttonRepeatWait, repeatinterval: scc.TClessbuttonRepeatInterval,
   ...
   params = {
      repeatwait: scc.TCmorebuttonRepeatWait, repeatinterval: scc.TCmorebuttonRepeatInterval,
   ...
   functions = {
      MouseDown: SocialCalc.ScrollAreaClick, Repeat: SocialCalc.ScrollAreaClick,
      Disabled: function () { return control.editor.busy; }
   };
   ...
   params = {
      normalstyle: "backgroundImage:url(" + imageprefix + "thumb-" + vh + "n.gif)", name: "Thumb",
