...
SocialCalc.Constants = {
   ...
   defaultCommentStyle: "background-repeat:no-repeat;background-position:top right;background-image:url(images/sc-commentbg.svg);", // style added to cells with non-null comments when grid enabled
   ...
   defaultColnameStyle: "font-size:small;text-align:center;color:#FFFFFF;background-color:#808080;cursor:e-resize;padding:3px 0;",
   defaultSelectedColnameClass: "", // column with selected cell, needs a cursor property 
   defaultSelectedColnameStyle: "font-size:small;text-align:center;color:#FFFFFF;background-color:#404040;cursor:e-resize;padding:3px 0;",
   defaultRownameClass: "", // regular row heading numbers
   defaultRownameStyle: "font-size:small;text-align:right;color:#FFFFFF;background-color:#808080;padding:0 6px;",
   defaultSelectedRownameClass: "", // column with selected cell, needs a cursor property 
   defaultSelectedRownameStyle: "font-size:small;text-align:right;color:#FFFFFF;background-color:#404040;padding:0 6px;",
   ...
   SCTabbackground: "background-color:#404040;",
   SCTabselectedCSS: "font-size:x-small;padding:4px 20px;color:#FFF;background-color:#555;cursor:pointer;border-right:1px solid #333;border-bottom:2px solid #555;",
   SCTabplainCSS: "font-size:x-small;padding:4px 20px;color:#CCC;background-color:#404040;cursor:pointer;border-right:1px solid #333;transition:background-color 0.2s;",
   ...
   SCFormatEditable: "[cancel]:|[break]:|%loc!unset!:|%loc!Yes!:yes|%loc!No!:no|",
   SCFormatConstraints: "[cancel]:|[break]:|%loc!None!:|%loc!Checkbox!:checkbox|%loc!Date!:date|%loc!Phone!:phone|",
