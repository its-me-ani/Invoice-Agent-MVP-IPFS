...
| `Auth/AuthApiHandler` | JSON API auth for mobile app (Invoice) |
...
| `AppAgentHandler` | Invoice App cloud agent with IPFS |
...
│   └── AppAgentHandler.py           # Invoice cloud agent + IPFS
│
...
| `PINATA_JWT` | Pinata IPFS JWT (for invoice cloud agent) |
...
```json
{
  "userId": "user_email",
  "cid": "bafyrei...",
  "name": "Invoice Report (2024-01-15)",
