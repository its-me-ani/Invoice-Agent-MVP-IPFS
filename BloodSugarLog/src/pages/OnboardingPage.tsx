                        ...
                        >
                            ...
                            <div className="step-header">
                                ...
                                >
                                 ...
                                 <h1 className="step-title">Welcome to Invoice</h1>
                                <p className="step-subtitle">Offline invoice maker, billing tracker, and record keeper.</p>
                            </div>
                                ...
                                <div className="onboarding-welcome">
                                    <div className="welcome-features">
                                        <div className="feature-item">
                                            ...
                                            <span>Create and customize professional invoices and bills offline</span>
                                        </div>
                                        <div className="feature-item">
                                            <IonIcon icon={checkmarkCircle} color="success" />
                                            <span>Manage client details, line items, taxes, and payment totals effortlessly</span>
                                        </div>
                                        <div className="feature-item">
                                            <IonIcon icon={checkmarkCircle} color="success" />
                                            <span>Generate professional PDF invoices and share financial records securely</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
