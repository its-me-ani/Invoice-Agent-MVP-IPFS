        ...
        try {
            ...
            if (!canCreate) {
                presentAlert({
                    ...
                    message: `You can save a maximum of ${localTemplateService.maxInvoices} invoice files. Please delete some files before creating a new one.`,
                    buttons: ['OK']
                });
                return;
            }
            ...
            <header className="dashboard-header">
                <div style={{ display: 'flex', alignItems: 'center' }}>
                    <div style={{ display: 'flex', alignItems: 'center', marginLeft: '4px' }}>
                        <h1 style={{ fontSize: '18px', fontWeight: 600, margin: 0 }}>Invoice</h1>
                    </div>
                </div>
