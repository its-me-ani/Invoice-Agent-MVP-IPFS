...
console.log('VALIDATING FORMULA TRAINING DATASET');
console.log('='.repeat(70));
...
files.forEach((file, index) => {
    ...
    if (result.valid) {
        const formulaCount = content.split('\n').filter(l => l.includes('vtf:')).length;
        console.log(`  ✅ VALID - ${result.cells} cells, ${formulaCount} formulas`);
        totalValid++;
    } else {
